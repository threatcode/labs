data "aws_route53_zone" "khulnasoft" {
  name         = "khulnasoft.com."
  private_zone = false
}

resource "aws_route53_zone" "khulnasoft" {
  name = "khulnasoft.pvt"
...
resource "aws_route53_record" "api" {
  zone_id = aws_route53_zone.khulnasoft.zone_id
  name    = "api"
  type    = "A"
  ttl     = 300
...
resource "aws_route53_record" "grafana" {
  zone_id = data.aws_route53_zone.khulnasoft.zone_id
  name    = "grafana"
  type    = "A"
  ttl     = 300
